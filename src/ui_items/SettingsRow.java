...
//
	public SettingsRow(ImageIcon textBar,String option1,String option2,String type1,String type2,int order) {
		...
		this.option1B = new Button(2*spacing+textBarW+textBarX,(textBarH-optionHeight)/2,optionWidth,optionHeight,option1,type1,true);
		this.option2B = new Button(3*spacing+textBarW+textBarX+optionWidth,(textBarH-optionHeight)/2,optionWidth,optionHeight,option2,type2,true);
	...
	public static void changeResolution(int w,int h) {
		if(Main.isFullScreen == true) return;
		Main.WIDTH = w;
		Main.HEIGHT = h;
		Main.updateScreen();
	}
